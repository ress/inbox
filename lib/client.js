...
IMAPClient.prototype._formatEnvelope = function(envelopeData){
    ...
    if(dataObject.ENVELOPE){
        ...
        if( dataObject.ENVELOPE[2] && typeof dataObject.ENVELOPE[2] === 'string' ){

            dataObject.ENVELOPE[2] = [ [ dataObject.ENVELOPE[2], null, dataObject.ENVELOPE[4], dataObject.ENVELOPE[6] ] ];
            dataObject.ENVELOPE[3] = [ [ dataObject.ENVELOPE[8], null, dataObject.ENVELOPE[10], dataObject.ENVELOPE[12] ] ];
            dataObject.ENVELOPE[4] = [ [ dataObject.ENVELOPE[14], null, dataObject.ENVELOPE[16], dataObject.ENVELOPE[18] ] ];

            dataObject.ENVELOPE[5] = null;
            dataObject.ENVELOPE[6] = null;
            dataObject.ENVELOPE[8] = null;
