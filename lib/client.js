...
IMAPClient.prototype._postCapability = function(){
    if(this._currentState == this.states.PREAUTH){
        ...
        if(this._capabilities.indexOf("AUTH=XOAUTH2")>=0 && this.options.auth.XOAuth2){
            // FIXME: Add XOAUTH2 login option
...
IMAPClient.prototype._formatEnvelope = function(envelopeData){
    ...
    if(dataObject["X-GM-LABELS"] && dataObject["X-GM-LABELS"].length){
        message.xGMLabels = (dataObject["X-GM-LABELS"] || []).map((function(label){
            var type;
