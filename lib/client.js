 ...
 */
IMAPClient.prototype.IDLE_TIMEOUT = 30 * 1000;
...
IMAPClient.prototype._formatEnvelope = function(envelopeData){
    ...
    var dataObject = {}, lastKey = false, headers;
...
IMAPClient.prototype._checkNewMail = function(){
    ...
    this._send("UID FETCH "+this._selectedMailbox.UIDNext+":* (FLAGS ENVELOPE BODY[HEADER.FIELDS (REFERENCES)])", (function(){
        this._checkForNewMail = false;
    }).bind(this), 
    (function(){
